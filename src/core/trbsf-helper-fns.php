...
// Example: Write {include tr_part('hero')}
// instead of: {include tr_part('parts/hero')}
if (!function_exists('tr_part')) {
	function tr_part($part_name) {
		return TRBSF_PLUGIN_BASE_DIR . "views/parts/$part_name.latte";
	}
}
 ...
 */
if (!function_exists('tr_get_media_path')) {
...
if (!function_exists('tr_get_media')) {
...
if (!function_exists('tr_get_svg')) {
	function tr_get_svg(
		...
		$correct_svg_file_path = $from_media
			? $file_name_or_uploads_path
			: TRBSF_PLUGIN_BASE_URI . 'assets/svg/' . $file_name_or_uploads_path;
...
if (!function_exists('tr_get_img_path')) {
	function tr_get_img_path($img_path) {
		$img_full_path = TRBSF_PLUGIN_BASE_URI . "assets/img/$img_path";
...
if (!function_exists('tr_get_img_sync')) {
...
if (!function_exists('tr_get_img_async')) {
...
if (!function_exists('tr_social_share')) {
 ...
 */
if (!function_exists('tr_last_updated_on')) {
...
if (!function_exists('tr_get_nav_menu_items_by_location')) {
...
if (!function_exists('tr_hex_to_rgb')) {
...
if (!function_exists('tr_str_ends_with')) {
...
if (!function_exists('tr_get_video_type_and_id')) {
...
if (!function_exists('tr_get_soc_name')) {
