...
const { config, config_webpack_js_admin_blocks } = require('./gulpfile_config.mjs')

// TODO: Add this to theme-redone as well
...
const paralell_tasks = [compileGutenbergBackendJS, copyGutenbergBlocksFiles]
for (const key in config.css) {
